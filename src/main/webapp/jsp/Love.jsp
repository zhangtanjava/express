...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link type="text/css" rel="stylesheet" href="../js/js1/default.css">
        <script type="text/javascript" src="../js/js1/jquery.min.js"></script>
        <script type="text/javascript" src="../js/js1/jscex.min.js"></script>
        <script type="text/javascript" src="../js/js1/jscex-parser.js"></script>
        <script type="text/javascript" src="../js/js1/jscex-jit.js"></script>
        <script type="text/javascript" src="../js/js1/jscex-builderbase.min.js"></script>
        <script type="text/javascript" src="../js/js1/jscex-async.min.js"></script>
        <script type="text/javascript" src="../js/js1/jscex-async-powerpack.min.js"></script>
        <script type="text/javascript" src="../js/js1/functions.js" charset="utf-8"></script>
        <script type="text/javascript" src="../js/js1/love.js" charset="utf-8"></script>
    </head>
    <body>
        <div id="main">
            ...
            <div id="wrap">
               <div id="text">
                   ...
                   <br>
                    <span class="say"><span class="space"></span> -- Yours, tantan.</span>
                    </div>
                </div>
                <div id="clock-box">
                    <a href="https://user.qzone.qq.com/1565028871/infocenter" target="_blank">@青霞</a> 与 <a href="https://user.qzone.qq.com/1057684878/infocenter" target="_blank">@张檀</a> 在一起的
                        <div id="clock"></div>
                </div>
